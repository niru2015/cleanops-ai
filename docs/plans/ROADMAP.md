...
- CLEAN-004: [active implementation](active/CLEAN-004.md). Private media, verified identities,
  context/pairing and unresolved queue; after-first and bad-media tests. Depends on 003.
