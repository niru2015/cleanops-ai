...
begin
  ...
  begin
    insert into public.inventory_transactions (
      organization_id, site_id, inventory_item_id, transaction_type, quantity, unit_cost, occurred_at
    ) values (
      '10000000-0000-4000-8000-000000000001', '40000000-0000-4000-8000-000000000002',
      v_item, 'receipt', 1, 1, now()
    );
    raise exception 'cross-site inventory entry unexpectedly succeeded';
