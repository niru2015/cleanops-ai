...
Status: Phase 0 documentation only; no application or live integrations exist yet.
...
Phase 0: validate local Markdown links and issue templates; no app commands exist.
CLEAN-001 must create documented scripts: `typecheck`, `lint`, `test`, `build`.
After scaffolding, run applicable scripts; include database isolation tests for schema/auth
